...
Before changing frontend code, review the relevant frontend skills and keep the implementation aligned with the current product language rather than inventing a new one.
