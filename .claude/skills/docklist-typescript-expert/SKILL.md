...
description: "DocklistAI TypeScript skill. Use for typed frontend data models, service contracts, safer component props, route data shapes, and avoiding weak any-based code."
category: framework
risk: critical
source: community
