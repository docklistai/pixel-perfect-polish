---
name: docklist-react-component-performance
description: "DocklistAI React component performance skill. Use when React components, route files, render paths, charts, tables, drawers, or UI state may become slow or over-complex."
risk: safe
