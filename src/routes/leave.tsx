...
const top = [
  ...
  },
  {
    l: "APPROVED UPCOMING",
    v: "18",
    s: "In the next 30 days",
    a: "View calendar",
    icon: Calendar,
    tone: "info",
  },
  {
    l: "SICKNESS / ABSENCE TODAY",
    v: "2",
    s: "2.6% of scheduled shifts",
    a: "View today",
    icon: Heart,
    tone: "purple",
  },
              ...
              <div key={r.n} className="rounded-xl border border-border p-3">
                ...
                <div className="mt-2 flex items-center justify-between text-[11px]">
                  ...
                  <div className="text-right">
                    ...
                    <div
                      className={`font-medium flex items-center gap-1 justify-end ${r.tone === "danger" ? "text-danger" : r.tone === "warning" ? "text-warning" : "text-success"}`}
                    >
                ...
                <div className="mt-2 flex gap-2">
                  <button className="flex-1 rounded-lg border border-border py-1.5 text-xs">
                    Decline
                  </button>
                  <button className="flex-1 rounded-lg bg-brand-soft text-brand py-1.5 text-xs font-semibold">
                    Approve
                  </button>
                </div>
              </div>
            ...
            {[
              {
                l: "A",
                t: "Rota clash",
                s: "Kitchen has limited coverage on 26 May.",
                link: "Review rota",
                tone: "warning",
              },
              {
                l: "♥",
                t: "High leave period",
                s: "18% of team on leave 24 – 31 May.",
                link: "See coverage",
                tone: "purple",
              },
            ].map((a) => (
              <div key={a.t} className="flex gap-3 py-2 border-t first:border-t-0 border-border">
                <div
                  className={`h-8 w-8 rounded-lg flex items-center justify-center font-semibold ${a.tone === "warning" ? "bg-warning-soft text-warning" : "bg-accent-purple-soft text-accent-purple"}`}
                >
                  {a.l}
                </div>
          ...
          <div className="grid grid-cols-3 gap-6">
            {[
              ...
              <div key={l}>
                <div className="text-xs text-muted-foreground">{l}</div>
                <div
                  className={`text-xl font-bold mt-1 text-${tone}`}
