      ...
      {liveEmpty ? (
        <Card className="p-5">
          <div className="flex items-start gap-2">
            ...
            <div>
              <div className="text-sm font-semibold">No live time data yet</div>
              <p className="mt-1 text-xs text-muted-foreground">
                Attendance trends and hours queries appear after staff clock entries exist. This
                page exports approved-hours CSVs only, not payroll.
              </p>
            </div>
          </div>
        </Card>
