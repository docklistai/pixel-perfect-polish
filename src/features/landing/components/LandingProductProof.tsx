  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(54% 44% at 50% 0%,rgba(14,165,162,.16),transparent 70%), radial-gradient(42% 42% at 86% 82%,rgba(201,149,77,.12),transparent 72%)",
        }}
      />
      ...
      <div className="relative mx-auto max-w-[1240px] px-6 lg:px-10">
        ...
        <div className="relative group">
          <div
            aria-hidden="true"
            className="absolute -inset-1 rounded-[20px] bg-gradient-to-b from-[rgba(255,255,255,0.06)] to-transparent opacity-0 blur-lg transition duration-700 group-hover:opacity-100"
          />
          <div
            className="landing-reveal relative overflow-hidden rounded-[18px] border border-white/[0.12]"
            style={{
              background: "rgba(17, 23, 20, 0.45)",
              backdropFilter: "blur(12px)",
              boxShadow:
                "0 60px 120px -20px rgba(0,0,0,0.9), inset 0 1px 1px rgba(255,255,255,0.1), inset 0 -1px 1px rgba(255,255,255,0.02)",
            }}
          >
            <div
                ...
                <div className="product-annotations pointer-events-none grid gap-2 sm:mt-0 sm:grid-cols-3">
                  {proofAnnotations.map((annotation) => (
                    <div
                      ...
                      className="relative rounded-xl border p-3 backdrop-blur-md transition-transform duration-300 motion-safe:group-hover:-translate-y-1"
                      style={{
                        background:
                          annotation.tone === "safe" ? "rgba(14,48,43,.85)" : "rgba(35,27,17,.85)",
                        borderColor:
                          annotation.tone === "safe"
                            ? "rgba(43,184,181,.35)"
                            : "rgba(201,149,77,.4)",
                        boxShadow:
                          "0 24px 48px -12px rgba(0,0,0,0.8), inset 0 1px 0 rgba(255,255,255,0.12)",
                      }}
                    >
                      ...
                      <div className="mt-1 flex items-baseline justify-between gap-3 sm:block sm:mt-1">
                        <p
                          ...
                          style={{
                            color:
                              annotation.tone === "safe" ? "var(--landing-teal-400)" : "#d9ad70",
